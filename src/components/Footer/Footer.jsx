      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex space-x-4">
          <a href="https://www.linkedin.com/in/matipere/" target="_blank" rel="noopener noreferrer">
            <img src={linkedin} alt="LinkedIn" className="w-6 h-6 hover:opacity-70 transition-all duration-300" />
          </a>
          <a href="https://github.com/MDPereyra22" target="_blank" rel="noopener noreferrer">
            <img src={github} alt="GitHub" className="w-6 h-6 hover:opacity-70 transition-all duration-300" />
          </a>
          <a href="https://wa.link/fz5i7j" target="_blank" rel="noopener noreferrer">
            <img src={phone} alt="Teléfono" className="w-6 h-6 hover:opacity-70 transition-all duration-300" />
          </a>
          <a href="mailto:pereyra.dmatias@gmail.com" target="_blank" rel="noopener noreferrer">
            <img src={sobre} alt="Correo" className="w-6 h-6 hover:opacity-70 transition-all duration-300" />
          </a>
